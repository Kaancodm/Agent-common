---
name: agent-common
description: Use when the user wants a general project task researched, structured, created, or implemented end to end and no narrower specialist Skill is a better match.
---
